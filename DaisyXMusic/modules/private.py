...
async def gstart(_, message: Message):
    await message.reply_text(
        f"""** 🔵 ＳＨＵＢＨΛＭ ⌬ ＭＵＳＩＣ is online**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💬 Support Chat", url=f"https://t.me/Music_Enviroment"
                    )
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '🎶Music Group🎶', url=f"https://t.me/Music_Enviroment")],
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""**🙋‍♀️ Hello there! I can play music in the voice chats of telegram groups & channels. Made by @RobotTech_official with ❤️**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
